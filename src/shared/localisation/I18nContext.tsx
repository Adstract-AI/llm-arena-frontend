...
const dictionaries = {
  en: {
    ...
    arena: {
      ...
      expandVotePanel: "Show voting options",
      collapseVotePanel: "Minimize voting options",
    ...
    chat: {
      ...
      noActiveModelsTitle: "Chat is temporarily unavailable.",
      noActiveModelsBody:
        "There are no active FINKI models available right now.",
      noActiveModelsMenu: "No active FINKI models are available right now.",
      ...
      problemTitle: "There was a problem with chat.",
      responseFailed: "The model could not finish its response.",
    },
    experimental: {
  ...
  mk: {
    ...
    arena: {
      ...
      expandVotePanel: "Прикажи опции за гласање",
      collapseVotePanel: "Минимизирај опции за гласање",
      submitVote: "Гласај",
      voteModel1: "Модел 1",
    ...
    chat: {
      ...
      noActiveModels: "Нема активни модели",
      noActiveModelsTitle: "Chat е привремено недостапен.",
      noActiveModelsBody: "Во моментов нема активни FINKI модели.",
      noActiveModelsMenu: "Во моментов нема активни FINKI модели.",
      ...
      sendingMessage: "Се испраќа порака",
      problemTitle: "Се појави проблем со chat.",
      responseFailed: "Моделот не успеа да го заврши одговорот.",
    },
    experimental: {
