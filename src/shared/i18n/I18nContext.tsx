...
const dictionaries = {
  en: {
    ...
    about: {
      ...
      lead:
        'MakArena compares anonymous models across a conversation, then uses user voting data to build transparent performance rankings. You can also use Chat mode for direct conversations with a single model, or Experimental Arena for more controlled comparison runs.',
      ...
      principle2: 'Conversation-level voting captures model quality across multiple turns.',
    ...
    auth: {
      ...
      callbackMissingCode: 'The provider did not return a login code. Please try again.',
    ...
    arena: {
      ...
      disclaimerLine2: 'Always double-check important facts before relying on them.',
      responses: 'Responses',
    ...
    experimental: {
      ...
      parametersHelper: 'Configure how parameter values are sampled for each run',
      on: 'On',
      off: 'Off',
      ...
      closeEditorFor: (label: string) => `Close editor for ${label.toLowerCase()}`,
      ...
      differentModelsDifferentParameters: 'Different models · different parameters',
      ...
      tooltipDifferentModelsBody: 'Compares two different models on the same prompt.',
      tooltipParameters: 'Parameters',
      tooltipModelSpecific: 'Model-specific (Different parameters)',
      tooltipModelSpecificBody: 'Each response uses independently sampled parameter values.',
      ...
      tooltipTopKBody: 'Limits token selection to the top K most likely options.',
      ...
      tooltipDistributionsIntro: 'Defines how parameter values are sampled for each run.',
  ...
  mk: {
    ...
    about: {
      eyebrow: 'За MakArena',
        ...
        lead:
            'MakArena споредува анонимни AI модели преку разговори, а гласовите од корисниците создаваат транспарентно рангирање според реални перформанси. Може да користиш и Chat за директен разговор со еден модел или Experimental Arena за понапредни и контролирани споредби.',
      ...
      principle1: 'Анонимната споредба ја намалува пристрасноста во проценката.',
      principle2: 'Гласањето на ниво на разговор овозможува попрецизна проценка на квалитетот низ повеќе пораки.',
      principle3: 'Метриките на Leaderboard-от се базираат на реални кориснички преференции и гласови.',
      fundingCollaboration: 'Финансирање и соработка',
      fundedBy: 'Финансирано од',
      finkiLogoAlt: 'Лого на Факултет за информатички науки и компјутерско инженерство',
      legal: 'Правно',
    ...
    auth: {
      ...
      chatGateDescription: 'Најави се за да започнеш Chat и да ги зачуваш разговорите.',
    ...
    arena: {
      ...
      disclaimerLine1: 'Одговорите може да бидат бавни, неточни или халуцинации.',
      disclaimerLine2:
    ...
    experimental: {
      ...
      parametersHelper: 'Постави како ќе се земаат вредностите на параметрите за секое извршување',
      on: 'On',
      off: 'Off',
      ...
      promptPlaceholderBlocked: 'Прво постави ја експерименталната конфигурација...',
      ...
      closeEditorFor: (label: string) => `Затвори уредувач за ${label.toLowerCase()}`,
      ...
      differentModelsDifferentParameters: 'Различни модели · различни параметри',
      ...
      tooltipDifferentModelsBody: 'Споредува два различни модели врз исто барање.',
      ...
      tooltipTopKBody: 'Го ограничува изборот на токени на топ K најверојатни опции.',
      tooltipFrequencyPenaltyBody:
      ...
      tooltipDistributionsIntro: 'Дефинира како се избираат вредностите на параметрите за секое извршување.',
      tooltipUniformBody: 'Вредностите се земаат рамномерно низ дефиниран опсег.',
      tooltipNormalBody:
    ...
    modelDetails: {
      ...
      couldNotLoad: 'Не успеавме да ги вчитаме деталите за моделот во моментов.',
